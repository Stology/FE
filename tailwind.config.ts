  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        label: ['13px', { lineHeight: '20.8px', fontWeight: '600' }],
        body: ['13px', { lineHeight: '20.8px', fontWeight: '500' }],
        caption: ['11px', { lineHeight: '17.6px', fontWeight: '400' }],
        'sidebar-section': ['11px', { lineHeight: '17.6px', fontWeight: '500' }],
      },
    },
  },
  plugins: [],
