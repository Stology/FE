...
const TEMPLATE_OPTIONS = [
  { value: '', label: '온톨로지 템플릿 선택' },
  { value: 'backend', label: '백엔드 마스터 템플릿' },
  { value: 'cs-core', label: 'CS 전공지식 템플릿' },
  { value: 'algorithm', label: '알고리즘 템플릿' },
  { value: 'frontend', label: '프론트엔드 개발 템플릿' },
  { value: 'custom', label: '자율 템플릿 (직접 구성)' },
];
